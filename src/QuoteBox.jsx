  ...
  return (
    <div id="quote-box" className="bg-gray-800 p-8 rounded-lg shadow-lg text-center max-w-lg transition-all duration-500 ease-in-out transform hover:scale-105">
      ...
      <button 
        id="new-quote" 
        onClick={fetchQuote} 
        className="bg-teal-500 text-white px-4 py-2 rounded hover:bg-teal-600 transition duration-300 shadow-md mr-20 md:mr-10"
      >
        New Quote
      </button>
      <a 
        ...
        className="inline-block text-teal-400 hover:underline transition duration-300 ml-20 md:ml-10"
      >
        Tweet
      </a>
    </div>
